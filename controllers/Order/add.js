...
//         // If the error is an instance of errorHandler, respond with the status code and message from the error
...
//         });
//       } else {
//         // If the error is not an instance of errorHandler, respond with a 500 status code and a generic error message
//         res.status(500).send({
//           type: RESPONSE_MESSAGE.FAILED,
